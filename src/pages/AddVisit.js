    ...
    <div style={{
      ...
      <div style={{ maxWidth: '700px', margin: '0 auto', padding: '28px 20px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* اختيار الدولة */}
          <div style={cardStyle}>
            <label style={labelStyle}>🌍 اختر الدولة</label>
          ...
          {/* التقييم */}
          <div style={cardStyle}>
            <label style={labelStyle}>⭐ تقييمك</label>
          ...
          <div style={cardStyle}>
            ...
            <textarea value={form.notes}
              ...
              placeholder="ما الذي أعجبك في هذه الرحلة؟"
              rows={3}
          ...
          {/* الصورة */}
          <div style={cardStyle}>
            <label style={labelStyle}>📸 صورة من الرحلة (اختياري)</label>
            {photoPreview && (
            ...
            <label style={{
              ...
              {photoPreview ? 'تغيير الصورة' : 'اضغط لاختيار صورة — JPG, PNG بحجم أقصى 5MB'}
          ...
          <button type="submit" disabled={loading} style={{
            ...
            background: loading ? 'rgba(255,255,255,0.06)' : 'linear-gradient(135deg, #C0392B, #E74C3C)',
